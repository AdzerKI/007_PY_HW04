...
if k < 1:
    ...
    for i in range (k, 0, -1):
        # тут много чего доделыывать, но алгоритм понятен, 
        # такое джунам дорабатывать отдал бы, например разделить 
        # 0 и 1 на разные события, но это тестер должен найти
        # расписывать такое сениора время дорого
        temp = randrange(0,9)
        ...
        if i != 0 and temp != 0:
            func += f"{temp}"
func += " = 0"
        # в файл поместить та же история, джунам
print(func) 
